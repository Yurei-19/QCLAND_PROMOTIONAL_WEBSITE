import { r as reactExports, R as React4, a as React3, b as reactDomExports, g as getAugmentedNamespace, j as jsxRuntimeExports } from "../index.js";
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: isDark ? /* @__PURE__ */ jsxRuntimeExports.jsx(MoonIcon, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(SunIcon, {})
    }
  );
}
function SunIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", className: "h-5 w-5 text-yellow-500", fill: "currentColor", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 2a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1Zm0 17a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0v-1a1 1 0 0 1 1-1Zm10-7a1 1 0 0 1-1 1h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 1 1ZM4 12a1 1 0 0 1-1 1H2a1 1 0 1 1 0-2h1a1 1 0 0 1 1 1Zm14.657 6.657a1 1 0 0 1-1.414 0l-.707-.707a1 1 0 0 1 1.414-1.414l.707.707a1 1 0 0 1 0 1.414ZM7.464 7.464A1 1 0 0 1 6.05 6.05l.707-.707A1 1 0 1 1 8.17 6.757l-.707.707Zm9.9-2.12.707-.708A1 1 0 0 1 19.485 6.05l-.707.707A1 1 0 1 1 17.05 5.343ZM6.05 19.485a1 1 0 0 1 0-1.414l.707-.707a1 1 0 1 1 1.414 1.414l-.707.707a1 1 0 0 1-1.414 0Z" })
  ] });
}
function MoonIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", className: "h-5 w-5 text-white", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79Z", strokeLinecap: "round", strokeLinejoin: "round" }) });
}
function Navbar() {
  const [open, setOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-black/5 bg-white/80 backdrop-blur-md dark:border-white/10 dark:bg-black/60", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-responsive flex items-center justify-between", style: { height: "72px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(distExports.Link, { to: "/", className: "relative flex items-center", style: { height: "48px", width: "160px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: (() => {
              const base = "/QCLAND_PROMOTIONAL-WEBSITE/";
              const withBase = (p) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden gap-6 md:flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, { to: "/", label: "Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, { to: "/gameplay", label: "Gameplay" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, { to: "/modelviewer", label: "Resources" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, { to: "/news", label: "News & Updates" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, { to: "/team", label: "The Team" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => setOpen((v) => !v),
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(BurgerIcon, { open })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-responsive flex flex-col py-3", style: { minHeight: open ? "auto" : "0" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, { to: "/", label: "Home", onClick: () => setOpen(false) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, { to: "/gameplay", label: "Gameplay", onClick: () => setOpen(false) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, { to: "/modelviewer", label: "Resources", onClick: () => setOpen(false) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, { to: "/news", label: "News & Updates", onClick: () => setOpen(false) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, { to: "/team", label: "The Team", onClick: () => setOpen(false) })
        ] })
      }
    )
  ] });
...
function BurgerIcon({ open }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: open ? "M6 6L18 18" : "M3 6h18", strokeLinecap: "round" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: open ? "M6 18L18 6" : "M3 12h18", strokeLinecap: "round" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: open ? "" : "M3 18h18", strokeLinecap: "round" })
  ] });
}
function MobileNav({ to, label, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    distExports.NavLink,
    {
      to,
      onClick,
      className: ({ isActive }) => `px-1 py-2 text-base font-semibold transition-colors ${isActive ? "text-[var(--color-primary)]" : "text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white"}`,
      children: label
    }
  );
}
function Nav({ to, label }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      to,
      className: ({ isActive }) => `text-sm font-semibold transition-colors ${isActive ? "text-[var(--color-primary)]" : "text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white"}`,
      children: label
    }
  );
}
...
Content not added yet — send the text you want here and I’ll paste it in.`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-20 bg-[#0B3A4B] text-slate-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-responsive px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        (() => {
          const base = "/QCLAND_PROMOTIONAL-WEBSITE/";
          const withBase = (p) => `${base.endsWith("/") ? base : base + "/"}${p.replace(/^\//, "")}`;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/logoQCLand.png"), alt: "QCUland", className: "block h-12 w-auto dark:hidden" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/2logoQCLand.png"), alt: "QCUland dark", className: "hidden h-12 w-auto dark:block" })
          ] });
        })(),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 max-w-2xl text-base leading-relaxed text-slate-200/90", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-8 md:pl-8 md:justify-items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-[var(--color-primary)] md:text-right", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3 text-sm md:text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/about", className: "hover:text-white", onClick: () => window.scrollTo({ top: 0, behavior: "auto" }), children: "About" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/gameplay", className: "hover:text-white", onClick: () => window.scrollTo({ top: 0, behavior: "auto" }), children: "Gameplay" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/news", className: "hover:text-white", onClick: () => window.scrollTo({ top: 0, behavior: "auto" }), children: "News" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/team", className: "hover:text-white", onClick: () => window.scrollTo({ top: 0, behavior: "auto" }), children: "Team" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto md:ml-0 md:justify-self-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-[var(--color-primary)] md:text-right", children: "Socials" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-col items-start md:items-end gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.facebook.com/profile.php?id=61587247695396", target: "_blank", rel: "noopener noreferrer", "aria-label": "Facebook", className: "inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/40 text-white hover:bg-black/50", children: fbIcon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://youtube.com/@qculand?si=JQiyl5_Yf4BO1JVN", target: "_blank", rel: "noopener noreferrer", "aria-label": "YouTube", className: "inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/40 text-white hover:bg-black/50", children: ytIcon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.instagram.com/qculand.cyber/", target: "_blank", rel: "noopener noreferrer", "aria-label": "Instagram", className: "inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/40 text-white hover:bg-black/50", children: igIcon })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-6 text-xs text-slate-300/80 sm:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        year,
        " QCULAND TEAM. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "hover:text-white", onClick: () => showPopup("Privacy Policy"), children: "Privacy Policy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "hover:text-white", onClick: () => showPopup("Terms of Service"), children: "Terms of Service" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/support", className: "hover:text-white", onClick: () => window.scrollTo({ top: 0, behavior: "auto" }), children: "Support" })
      ] })
    ] })
  ] }) });
}
const fbIcon = /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", className: "h-5 w-5 text-white", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 12a10 10 0 1 0-11.563 9.874v-6.987H7.898V12h2.54V9.797c0-2.506 1.492-3.89 3.776-3.89 1.094 0 2.24.195 2.24.195v2.464h-1.262c-1.244 0-1.632.772-1.632 1.562V12h2.776l-.444 2.887h-2.332v6.987A10.002 10.002 0 0 0 22 12Z" }) });
const ytIcon = /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", className: "h-5 w-5 text-white", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M23.499 6.203a3.002 3.002 0 0 0-2.115-2.123C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.384.58A3.002 3.002 0 0 0 .501 6.203C0 8.1 0 12 0 12s0 3.9.501 5.797a3.002 3.002 0 0 0 2.115 2.123C4.5 20.5 12 20.5 12 20.5s7.5 0 9.384-.58a3.002 3.002 0 0 0 2.115-2.123C24 15.9 24 12 24 12s0-3.9-.501-5.797ZM9.75 15.568V8.432L15.818 12 9.75 15.568Z" }) });
const igIcon = /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", className: "h-5 w-5 text-white", fill: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7Zm5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm0 2a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm5.75-.75a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5Z" }) });
...
function PageLoader({ visible }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity duration-200 ${visible ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, alt: "Loading", className: "h-40 w-40 md:h-52 md:w-52" })
    }
  );
}
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen overflow-hidden", style: { paddingTop: "96px", paddingBottom: "96px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "video",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/70 backdrop-blur-[2px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-responsive flex flex-col gap-12 max-w-4xl", style: { marginTop: "110px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { minHeight: "320px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-40 w-full max-w-[340px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: (() => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-2xl text-base sm:text-lg md:text-xl text-white", style: { minHeight: "84px" }, children: "Defend the campus network against the Phisher Bot. See through deception, solve logic puzzles, and restore the system." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center gap-6", style: { minHeight: "56px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/gameplay", className: "btn-primary px-6 py-3 text-base whitespace-nowrap", children: "Explore Gameplay" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/news", className: "inline-flex items-center text-base font-semibold text-[var(--color-primary)] hover:underline whitespace-nowrap", children: "Read Updates →" })
      ] })
    ] }) }) })
  ] });
}
function SectionHeading({ title, subtitle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 text-center", children: [
    ...
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-slate-600 dark:text-slate-300", children: subtitle })
  ] });
}
const slides$1 = [
  {
...
function ChapterOneCarousel() {
  const [index, setIndex] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const id = setInterval(() => setIndex((p) => (p + 1) % slides$1.length), 6e3);
    return () => clearInterval(id);
  }, []);
  const prev = () => setIndex((i) => (i - 1 + slides$1.length) % slides$1.length);
  const next = () => setIndex((i) => (i + 1) % slides$1.length);
  const active = slides$1[index];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-extrabold tracking-wide text-slate-900 dark:text-white drop-shadow-sm sm:text-4xl", children: "GAME CHAPTER" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-3 h-0.5 w-24 bg-[var(--color-primary)]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-12 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto flex h-[400px] items-center justify-center perspective-1000 sm:h-[440px]", children: slides$1.map((s, i) => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  ...
                  onError: (e) => {
                    e.currentTarget.src = "/qcu/placeholder.png";
                  }
                }
              ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft$1, {})
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight$1, {})
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex justify-center gap-2", children: slides$1.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl rounded-xl border border-black/10 bg-white/90 p-6 text-center shadow-md dark:border-white/15 dark:bg-black/70", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold tracking-wide text-slate-900 dark:text-white", children: 'Chapter 1 – "Shadows in the System"' }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mt-5 text-xl font-bold text-slate-900 dark:text-white sm:text-2xl", children: active.title }),
      active.subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm font-medium text-slate-600 dark:text-slate-300", children: active.subtitle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: active.description })
    ] })
  ] });
}
function ArrowLeft$1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: "h-5 w-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M15 18l-6-6 6-6", strokeLinecap: "round", strokeLinejoin: "round" }) });
}
function ArrowRight$1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: "h-5 w-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 6l6 6-6 6", strokeLinecap: "round", strokeLinejoin: "round" }) });
}
const JuanPic = "data:image/png;base64,aVZCT1J3MEtHZ29BQUFBTlNVaEVVZ0FBQUFFQUFBQUJDQVFBQUFDMUhBd0NBQUFBQzBsRVFWUjQybVA4L3g4QUF1c0I5WTBDMXY4QUFBQUFTVVZPUks1Q1lJST0=";
const BeePic = "data:image/png;base64,aVZCT1J3MEtHZ29BQUFBTlNVaEVVZ0FBQUFFQUFBQUJDQVFBQUFDMUhBd0NBQUFBQzBsRVFWUjQybVA4L3g4QUF1c0I5WTBDMXY4QUFBQUFTVVZPUks1Q1lJST0=";
const CipherPic = "data:image/png;base64,aVZCT1J3MEtHZ29BQUFBTlNVaEVVZ0FBQUFFQUFBQUJDQVFBQUFDMUhBd0NBQUFBQzBsRVFWUjQybVA4L3g4QUF1c0I5WTBDMXY4QUFBQUFTVVZPUks1Q1lJST0=";
const PhisherPic = "data:image/png;base64,aVZCT1J3MEtHZ29BQUFBTlNVaEVVZ0FBQUFFQUFBQUJDQVFBQUFDMUhBd0NBQUFBQzBsRVFWUjQybVA4L3g4QUF1c0I5WTBDMXY4QUFBQUFTVVZPUks1Q1lJST0=";
const RansomwarePic = "data:image/png;base64,aVZCT1J3MEtHZ29BQUFBTlNVaEVVZ0FBQUFFQUFBQUJDQVFBQUFDMUhBd0NBQUFBQzBsRVFWUjQybVA4L3g4QUF1c0I5WTBDMXY4QUFBQUFTVVZPUks1Q1lJST0=";
...
function CharacterCarousel() {
  const slides2 = reactExports.useMemo(
    () => [
  ...
  const [index, setIndex] = reactExports.useState(0);
  const prev = () => setIndex((i) => (i - 1 + slides2.length) % slides2.length);
  const next = () => setIndex((i) => (i + 1) % slides2.length);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-4xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl border border-black/5 bg-white shadow-card dark:border-white/10 dark:bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "flex transition-transform duration-500 ease-in-out",
        style: { transform: `translateX(-${index * 100}%)` },
        children: slides2.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-center gap-6 p-5 sm:grid-cols-2 sm:p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SmartImg, { src: s.src, fallback: s.fallback, alt: s.name, className: "h-56 w-full rounded-xl object-cover sm:h-72" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-extrabold sm:text-3xl", children: s.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-600 dark:text-slate-300 sm:text-base", children: s.desc })
          ] })
        ] }) }, s.name))
      }
    ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex justify-center gap-2", children: slides2.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        "aria-label": `Go to slide ${i + 1}`,
        onClick: () => setIndex(i),
...
const slides = [
  {
    ...
    // use qcu images
    title: "Game Synopsis",
    body: "When strange glitches and data leaks begin spreading across Quezon City University, one curious student, Juan, discovers that something sinister is manipulating the campus network. Guided by quick thinking and cyber awareness, Juan must defeat the malware creatures infecting each area of campus.\n\nOnly through smart choices, sharp eyes, and cyber hygiene can Juan restore safety to QCU."
  },
  {
    img: "/qcu/1 (2).jpeg",
    // swapped to qcu assets
    title: "Shadows in the System",
    body: "Strange data trails start flickering across the campus network. Juan follows the digital breadcrumbs and discovers Slybyte, a sneaky spyware creature hiding in plain sight. To move forward, Juan must outsmart this silent stalker before it learns too much."
  },
  {
    img: "/qcu/1 (3).jpeg",
    // swapped to qcu assets
    title: "The Face Behind the Fake",
    body: "Students begin receiving suspicious emails and fake login pages. Behind the deception lurks Phisher, a trickster entity that can disguise itself as anyone. Juan needs sharp instincts to see through its illusions and shut down its deceitful schemes."
  },
  {
    img: "/qcu/1 (4).jpeg",
    title: "The Endless Replication",
    body: "The network becomes unstable as copies of corrupted files multiply at breakneck speed. At the center of the chaos is Middlix, a worm-like creature spreading itself through every vulnerable path. Juan must cut off its growth before the system overloads."
  },
  {
    img: "/qcu/1 (5).jpeg",
    title: "Locked Out",
    body: "A digital lockdown sweeps across the servers. Files are encrypted, access is denied, and panic sets in. Emerging from the code is Encryphor, a cold, mechanical ransomware entity demanding control. Juan must break through its unyielding defenses to free the system."
  },
  {
    img: "/qcu/1 (6).jpeg",
    title: "Cipher’s Dominion",
    body: "All paths lead to the mastermind: Cipher, an adaptive, evolving AI that manipulates every layer of the digital world. With the entire network at stake, Juan faces a battle that will decide the future of the system and everyone relying on it."
  }
];
function GameSynopsisSection() {
  const [index, setIndex] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const t = setInterval(() => setIndex((i) => (i + 1) % slides.length), 6e3);
    return () => clearInterval(t);
  }, []);
  const next = () => setIndex((i) => (i + 1) % slides.length);
  const prev = () => setIndex((i) => (i - 1 + slides.length) % slides.length);
  const active = slides[index];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-responsive pt-8 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-wide text-[var(--color-primary)]", children: "QCULAND'S" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-extrabold tracking-wide text-slate-900 dark:text-white sm:text-4xl", children: "GAME SYNOPSIS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3 sm:items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-black/10 bg-white/90 p-3 text-sm shadow-sm dark:border-white/10 dark:bg-black/60 dark:text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Genre:" }),
          " Puzzle-Action, Narrative"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-black/10 bg-white/90 p-3 text-sm shadow-sm dark:border-white/10 dark:bg-black/60 dark:text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Platform:" }),
          " Browser"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-black/10 bg-white/90 p-3 text-sm shadow-sm dark:border-white/10 dark:bg-black/60 dark:text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Release Date:" }),
          " TBA"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative -mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto mb-8 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto flex h-[340px] items-center justify-center perspective-1000 sm:h-[380px] md:h-[440px]", children: slides.map((s, i) => {
          const offset = i - index;
          const abs = Math.abs(offset);
          const translateX = offset * 180;
          const rotateY = offset * -25;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex justify-center gap-2", children: slides.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          "aria-label": `Go to slide ${i + 1}`,
          onClick: () => setIndex(i),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 mx-auto max-w-3xl rounded-xl border border-black/10 bg-white/90 p-6 text-center shadow-md dark:border-white/15 dark:bg-black/70", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-slate-900 dark:text-white", children: active.title }),
      active.body.split("\n").map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: p }, i))
    ] })
  ] });
}
function Home() {
  const [mapOpen, setMapOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GameSynopsisSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChapterOneCarousel, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-responsive py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { title: "Characters" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CharacterCarousel, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/55 transition-opacity group-hover:bg-black/50" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-full w-full p-6 sm:p-10 flex items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-extrabold tracking-wide text-white sm:text-4xl", children: "QCU LAND MAP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-xl text-sm text-white/90", children: "Click to view the full campus layout and explore zones." })
          ] }) })
        ]
      }
    ) }),
    mapOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        "aria-modal": "true",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-5xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
function FeatureCard({ title, description }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-surface bg-white p-6 dark:bg-black", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-600 dark:text-slate-300", children: description })
  ] });
}
function Gameplay() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { title: "Gameplay", subtitle: "Master deception, solve logic, and battle bots." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-surface mx-auto max-w-4xl bg-white p-0 text-center dark:bg-black overflow-hidden rounded-2xl", children: (() => {
      const base = "/QCLAND_PROMOTIONAL-WEBSITE/";
      const withBase = (p) => {
        const cleaned = p.replace(/^\//, "").split("/").map(encodeURIComponent).join("/");
        return `${base.endsWith("/") ? base : base + "/"}${cleaned}`;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid gap-6 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureCard, { title: "Visual Deception", description: "Identify forged paths and unmask illusions in hostile networks." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureCard, { title: "Logic Puzzles", description: "Route signals, decode keys, and unlock secured channels." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureCard, { title: "Bot Battles", description: "Outthink the Phisher Bot with timing, tools, and tactics." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 rounded-xl bg-[var(--color-primary)] p-8 text-center text-white shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-extrabold", children: "Ready to Defend the Network?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function NewsCard({ item }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "card-surface group flex flex-col gap-3 bg-white p-5 dark:bg-black", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center rounded-full bg-brand-secondary/20 px-3 py-1 text-xs font-semibold text-[var(--color-primary)] ring-1 ring-brand-secondary/30", children: item.category }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("time", { className: "text-xs text-slate-500 dark:text-slate-400", children: new Date(item.date).toLocaleDateString() })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold group-hover:text-[var(--color-primary)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: `/news/${item.slug}`, children: item.title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 dark:text-slate-300", children: item.summary }),
...
function NewsIndex() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { title: "News & Updates", subtitle: "Patch notes, announcements, and events." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: [...news].sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(NewsCard, { item: n }, n.slug)) })
  ] });
}
function NewsShow() {
  ...
  const base = "/QCLAND_PROMOTIONAL-WEBSITE/";
  const withBase = (p) => p ? `${base.endsWith("/") ? base : base + "/"}${p.replace(/^\//, "")}` : void 0;
  if (!item) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/news", className: "text-sm text-[var(--color-primary)] hover:underline", children: "← Back to News & Updates" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-6 text-2xl font-bold", children: "Not Found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 dark:text-slate-300", children: "The requested announcement does not exist." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden", children: [
        ...
        "div",
        {
          ...
          style: {
            backgroundImage: (() => {
              ...
              const src = item.slug === "capstone-defense-schedule-announcement" ? capstoneBg : item.image || void 0;
              return src ? `url(${withBase(src)})` : void 0;
            })(),
            backgroundSize: "cover",
            backgroundPosition: "center"
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/55 backdrop-blur-sm" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-responsive relative py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/news", className: "text-sm text-[var(--color-primary)] hover:underline", children: "← Back to News & Updates" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid grid-cols-1 items-start gap-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl rounded-2xl border border-white/10 bg-black/30 p-6 text-white shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold tracking-widest", children: "WHAT'S NEW?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-2 text-3xl font-extrabold sm:text-4xl", children: item.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-white/90", children: "The holidays have arrived at Quezon City University, but the Shadow Network never sleeps. While the campus glows with Christmas lights, glitches and cyber threats continue to spread. Arius, the Student Defender must now protect QCU during the festive season, facing malware creatures wrapped in holiday disguises." }),
          item.slug === "capstone-defense-schedule-announcement" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-white/80", children: "Our team will defend Capstone 1 on Saturday from 8:00 AM to 9:30 AM. We're aiming for a solid, confident defense and appreciate everyone's support. After the session, we'll share a short recap with highlights and learnings." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-3 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-white/20 px-3 py-1 ring-1 ring-white/20", children: item.category }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("time", { className: "text-white/80", children: new Date(item.date).toLocaleDateString() })
          ] })
        ] }) })
      ] })
    ] }),
    item.slug === "qculand-christmas-update-v1-2" ? /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Festive Campus Skins" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Snow-covered halls, twinkling lights, and decorated servers bring holiday cheer." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Holiday Costumes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Arius and allies now feature Christmas-themed outfits." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Seasonal Enemy Variants" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Slybyte, Spoof, Middlix, and Encryphor appear with glitchy holiday disguises." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Special Event Quests" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Collect “Cyber Bells” by practicing safe online habits to unlock rewards." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Winter Effects" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "New animations of falling snow and frosty glitches across the digital world." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Bug Fixes & Improvements" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Optimized performance for smoother gameplay during festive effects" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Fixed minor dialogue overlaps in Chapter 2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Improved login security prompts for the event quests" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Upcoming in January 2026" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "New Year’s Challenge: “Firewall Resolutions”" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Expanded campus zones with fresh cyber puzzles" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Chapter 5: Cipher’s Dominion — the final showdown" })
        ] })
      ] })
    ] }) }) : item.slug === "npc-implementation-progress" ? /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "NPC Schedules" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Daily routines for shopkeepers, mentors, and quest givers across campus." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Dialogue Trees" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Branching conversations with hints, lore, and quest-related guidance." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Interactions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Contextual prompts: shop, mentor advice, mini-quests, and rewards." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Zone Coverage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Dorm, Admin, Library, and Main Gate get first NPC pass." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Progress & Next Steps" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Baseline schedules implemented for 4 NPC archetypes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Dialogue editor draft with branching preview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Interaction triggers tied to map hotspots" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Incoming Days" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Voice lines for mentors and shopkeepers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Quest chains with checkpoints and rewards" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Ambient behaviors: idle, roam, and react" })
        ] })
      ] })
    ] }) }) : item.slug === "room-refinement-for-gameplay" ? /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Layout Tightening" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Reduced empty space and improved flow for puzzle rooms." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Collision Polish" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Cleaner colliders to prevent snagging and odd pathing." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Objective Clarity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Better markers, signage, and prompt timings for tasks." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Lighting & Readability" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Balanced lighting, improved contrast, and reduced visual noise." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Fixes & Improvements" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Smoothed navigation paths and checkpoint placement" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Adjusted puzzle prompts and timer windows" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Aligned interactive zones with visual cues" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Next Iterations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "New puzzles with layered objectives" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Visual feedback on success/failure states" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Accessibility tweaks for color and text size" })
        ] })
      ] })
    ] }) }) : item.slug === "qcu-map-enhancements" ? /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Landmark Highlights" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Key campus points called out with clear labels and icons." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Wayfinding Signage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Consistent directional markers across zones and corridors." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Mini-map Readability" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Higher contrast, simplified icons, and clearer player marker." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Navigation Cues" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Breadcrumbs and glow cues for main quest routes." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Improvements & Next" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Cleaned overlapping signage near Main Gate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Balanced mini-map scale for dense areas" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Integrated quest waypoints with POIs" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Upcoming" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Photo mode markers for landmarks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Fast-travel tests between zones" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Campus events overlay on the map" })
        ] })
      ] })
    ] }) }) : item.slug === "capstone-defense-schedule-announcement" ? /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Schedule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "Saturday, 8:00–9:30 AM - Capstone 1 Defense session." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Focus" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "QCULand progress overview, NPCs, rooms, and map enhancements." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Support" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-700 dark:text-slate-300", children: "We appreciate your support; recap with highlights to follow." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-slate-900 dark:text-white", children: "Notes & Next" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Preparation includes gameplay refinements and performance checks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Post-session recap will include key learnings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Upcoming devlogs to track progress milestones" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-6 text-lg font-bold text-slate-900 dark:text-white", children: "Related" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-2 list-disc pl-5 text-sm text-slate-700 dark:text-slate-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "NPC behavior rollouts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Room layout and collision polish" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "QCU map wayfinding improvements" })
        ] })
      ] })
    ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-responsive py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "prose max-w-none dark:prose-invert", children: item.body.split("\n").map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: line }, i)) }) })
  ] });
}
const team = [
...
function TeamCard({ member }) {
  const base = "/QCLAND_PROMOTIONAL-WEBSITE/";
  const withBaseSmart = (p) => {
    const cleaned = p.replace(/^\//, "");
    const isEncoded = /%[0-9A-Fa-f]{2}/.test(cleaned);
    const finalPath = isEncoded ? cleaned : cleaned.split("/").map(encodeURIComponent).join("/");
    return `${String(base).replace(/\/$/, "")}/${finalPath}`;
  };
  const imgSrc = member.image ? withBaseSmart(member.image) : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-4 h-20 w-20 rounded-full bg-gradient-to-br from-brand-secondary/60 to-brand-primary/60 dark:from-brand-accent/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold", children: member.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[var(--color-primary)]", children: member.role }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-600 dark:text-slate-300", children: member.description })
      ]
    }
  );
}
function Team() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { title: "Meet the Team", subtitle: "Creators behind QCUland." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4", children: sorted.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(TeamCard, { member: m }, m.name)) })
  ] });
}
function ModelViewer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-extrabold tracking-wide text-slate-900 dark:text-white sm:text-4xl", children: "Resources" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-slate-700 dark:text-slate-200", children: "QCULAND Asset Viewer — browse and preview 3D game assets." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 overflow-hidden rounded-xl border border-black/10 bg-white/90 shadow-sm dark:border-white/15 dark:bg-black/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
        title: "Model Viewer",
...
function Maintenance() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container-responsive py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-3xl overflow-hidden rounded-2xl border border-black/10 bg-white shadow-card dark:border-white/10 dark:bg-black/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[var(--color-primary)]/10 p-8 sm:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-xl text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-extrabold text-slate-900 dark:text-white sm:text-3xl", children: "QCULAND System Upgrade in Progress" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-sm text-slate-700 dark:text-slate-200", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary bg-[var(--color-primary)] text-white hover:bg-brand-secondary", children: "← Return to Home Base" }) }) })
  ] }) }) }) });
}
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-5xl gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-surface bg-white p-6 dark:bg-black", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold", children: "About the Project" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "QCU LAND is a web-based, story-driven educational game developed by Bachelor of Science in Information Technology students of Quezon City University as part of their capstone project. The system is designed to promote cybersecurity awareness and responsible digital behavior among university students through an interactive and gamified learning experience." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "The game takes place in a virtual campus environment where users explore different buildings such as academic facilities, administrative offices, and public areas. Each location presents mission-based scenarios that simulate real-world cybersecurity threats including phishing attacks, weak password usage, unsafe public Wi-Fi connections, social engineering tactics, and data privacy risks." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "Through decision-making activities, feedback mechanisms, and assessment challenges, QCU LAND enables students to recognize online threats and apply safe digital practices in a controlled learning environment. The system integrates user-centered design and gamification elements to improve engagement, knowledge retention, and behavioral change." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "QCU LAND aims to bridge the gap between theoretical cybersecurity knowledge and practical application by transforming traditional awareness training into an immersive, accessible, and student-friendly educational platform." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-surface bg-white p-6 dark:bg-black", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold", children: "Who Are We" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "We are QCU students working together on a capstone project centered on cybersecurity awareness. Our team designed QCULAND to introduce essential safety concepts in a way that feels practical and relatable, especially for everyday browsing, school accounts, and common online services." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "Through the game’s challenges, we highlight threats such as phishing attempts, weak or reused passwords, unsafe browsing habits, and other risky behaviors that can lead to compromised accounts or data loss." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-surface bg-white p-6 dark:bg-black", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold", children: "Our Capstone Core" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "Our core focus is to deliver cybersecurity learning through gameplay, clear, interactive, and grounded in real scenarios." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-lg border border-black/10 bg-white/80 p-4 text-sm text-slate-700 shadow-sm dark:border-white/10 dark:bg-black/40 dark:text-slate-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-900 dark:text-white", children: "Game-based cybersecurity learning" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Learn by doing, not just by reading." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-lg border border-black/10 bg-white/80 p-4 text-sm text-slate-700 shadow-sm dark:border-white/10 dark:bg-black/40 dark:text-slate-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-900 dark:text-white", children: "Interactive threat simulations" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Challenges mirror common online attacks and mistakes." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-lg border border-black/10 bg-white/80 p-4 text-sm text-slate-700 shadow-sm dark:border-white/10 dark:bg-black/40 dark:text-slate-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-900 dark:text-white", children: "Recognition and prevention" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Spot warning signs and choose safer actions." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-lg border border-black/10 bg-white/80 p-4 text-sm text-slate-700 shadow-sm dark:border-white/10 dark:bg-black/40 dark:text-slate-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-900 dark:text-white", children: "Simple, understandable learning" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Security concepts are explained in accessible terms." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl bg-[var(--color-primary)] p-8 text-white shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-extrabold", children: "Building a Safer Digital Future" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-white/90 sm:text-base", children: "Our goal is to help players develop awareness of cybersecurity risks and gain habits that protect personal information online. By practicing prevention-focused decisions, like verifying links, using strong passwords, and avoiding suspicious downloads, learners can reduce the chances of becoming victims of cyber attacks." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-white/90 sm:text-base", children: "QCULAND promotes responsible internet use, digital safety, and confidence in navigating modern online spaces, skills that matter for students today and for the wider community." })
      ] })
    ] })
  ] });
}
const SUPPORT_EMAIL = "varca.peterjohn.i@gmail.com";
function Support() {
  const [name, setName] = reactExports.useState("");
  const [email, setEmail] = reactExports.useState("");
  const [message, setMessage] = reactExports.useState("");
  const mailtoHref = reactExports.useMemo(() => {
    const subject = "QCULAND Support Inquiry";
    const body = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-responsive py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-surface bg-white p-6 dark:bg-black", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:text-base", children: "Our team will respond to your inquiry as soon as possible." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-xl border border-black/10 bg-white/80 p-4 text-sm text-slate-700 shadow-sm dark:border-white/10 dark:bg-black/40 dark:text-slate-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-slate-900 dark:text-white", children: "Tip" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: "Include screenshots (if available), what you were doing, and the page where the issue happened." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-surface bg-white p-6 dark:bg-black", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold", children: "Send a Message" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-200", children: "This form prepares an email to our support inbox." }),
          ...
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "grid gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: "Your Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    value: name,
                    onChange: (e) => setName(e.target.value),
                    className: "h-11 rounded-lg border border-black/10 bg-white px-4 text-sm text-slate-900 shadow-sm outline-none focus:ring-2 focus:ring-[var(--color-primary)] dark:border-white/10 dark:bg-black/40 dark:text-white",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "grid gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: "Your Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    value: email,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "grid gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: "Your Message" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "textarea",
                  {
                    value: message,
                    onChange: (e) => setMessage(e.target.value),
                    className: "min-h-[140px] resize-y rounded-lg border border-black/10 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm outline-none focus:ring-2 focus:ring-[var(--color-primary)] dark:border-white/10 dark:bg-black/40 dark:text-white",
                    placeholder: "Your Message"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn-primary mt-2 w-full", children: "Submit" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: `mailto:${SUPPORT_EMAIL}`,
                  className: "text-center text-xs text-slate-600 hover:underline dark:text-slate-300",
                  children: [
...
function AppShell() {
  const isBrowser3 = typeof document !== "undefined";
  if (!isBrowser3) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(RouteLoader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollToTop, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(distExports.Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/about", element: /* @__PURE__ */ jsxRuntimeExports.jsx(About, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/gameplay", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Gameplay, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/news", element: /* @__PURE__ */ jsxRuntimeExports.jsx(NewsIndex, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/news/:slug", element: /* @__PURE__ */ jsxRuntimeExports.jsx(NewsShow, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/team", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Team, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/modelviewer", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ModelViewer, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/maintenance", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Maintenance, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Route, { path: "/support", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Support, {}) })
    ] }),
...
function RouteLoader() {
  ...
  const [prevPath, setPrevPath] = reactExports.useState(location2.pathname);
  const [visible, setVisible] = reactExports.useState(true);
  reactExports.useEffect(() => {
    const nextPath = location2.pathname || "/";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, { visible });
}
const export_26ad4b834941 = {
  AppShell
};
export {
  export_26ad4b834941
