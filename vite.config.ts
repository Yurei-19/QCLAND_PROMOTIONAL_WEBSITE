...
export default defineConfig(({ mode }) => ({
  // Use root base in dev; use subpath only for production deploys
  // This avoids HMR switching to `/QCLAND---PROMOTIONAL-WEBSITE/` locally
  base: mode === 'production' ? '/QCLAND_PROMOTIONAL-WEBSITE/' : '/',
  plugins: [
    rsc({
