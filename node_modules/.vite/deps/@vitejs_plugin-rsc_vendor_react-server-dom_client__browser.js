...
var require_react_server_dom_webpack_client_browser_development = __commonJS({
  "node_modules/@vitejs/plugin-rsc/dist/vendor/react-server-dom/cjs/react-server-dom-webpack-client.browser.development.js"(exports) {
    "use strict";
    (function() {
        ...
        if ("pending" === chunk.status || "blocked" === chunk.status) {
          ...
          for (var debugInfo = [], i = 0; i < value.length; ) {
            ...
            if (void 0 === ioInfo) {
              ...
              resourceEntries.value = { chunkId, href };
      ...
      function loadServerReference(response, metaData, parentObject, key) {
        ...
        if (promise)
          ...
          return promise = requireModule(serverReference), registerBoundServerReference(promise, metaData.id, metaData.bound), promise;
        if (initializingHandler) {
          var handler = initializingHandler;
          handler.deps++;
        } else
      ...
      function processFullStringRow(response, streamState, id, tag, row) {
        switch (tag) {
          ...
          default:
            if ("" === row) {
              if (streamState = response._chunks, (row = streamState.get(id)) || streamState.set(id, row = createPendingChunk(response)), "pending" === row.status || "blocked" === row.status)
                releasePendingChunk(response, row), response = row, response.status = "halted", response.value = null, response.reason = null;
            } else
              tag = response._chunks, (chunk = tag.get(id)) ? (resolveChunkDebugInfo(streamState, chunk), resolveModelChunk(response, chunk, row)) : (response = createResolvedModelChunk(response, row), resolveChunkDebugInfo(streamState, response), tag.set(id, response));
        }
      }
      function processBinaryChunk(weakResponse, streamState, chunk) {
        if (void 0 !== weakResponse.weak.deref()) {
          ...
          for (incrementChunkDebugInfo(streamState, chunkLength); i < chunkLength; ) {
            ...
            if (-1 < lastIdx)
              rowLength = new Uint8Array(chunk.buffer, offset, lastIdx - i), processFullBinaryRow(
                response,
                streamState,
                weakResponse,
                rowTag,
                buffer,
                rowLength
              ), i = lastIdx, 3 === rowState && i++, rowLength = weakResponse = rowTag = rowState = 0, buffer.length = 0;
            else {
      ...
      function createResponseFromOptions(options) {
        var debugChannel = options && void 0 !== options.debugChannel ? {
          ...
          callback: void 0 !== options.debugChannel.writable ? createDebugCallbackFromWritableStream(
      ...
      var React = require_react(), ReactDOM = require_react_dom(), decoderOptions = { stream: true }, bind = Function.prototype.bind, hasOwnProperty = Object.prototype.hasOwnProperty, chunkCache = /* @__PURE__ */ new Map(), chunkMap = /* @__PURE__ */ new Map(), webpackGetChunkFilename = __webpack_require__.u;
...
// node_modules/@vitejs/plugin-rsc/dist/vendor/react-server-dom/client.browser.js
var require_client_browser = __commonJS({
  "node_modules/@vitejs/plugin-rsc/dist/vendor/react-server-dom/client.browser.js"(exports, module) {
    if (false) {
      module.exports = null;
    } else {
...
//# sourceMappingURL=@vitejs_plugin-rsc_vendor_react-server-dom_client__browser.js.map
